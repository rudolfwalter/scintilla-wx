...
public:
	...
	Position ReplaceTarget(Sci::string_view text);
	Position ReplaceTargetRE(Sci::string_view text);
	Position ReplaceTargetMinimal(Sci::string_view text);
	Position SearchInTarget(Sci::string_view text);
	Span SpanSearchInTarget(Sci::string_view text);
