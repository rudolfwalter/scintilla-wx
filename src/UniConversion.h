...
size_t UTF8PositionFromUTF16Position(Sci::string_view u8Text, size_t positionUTF16) noexcept;
void UTF8FromUTF16(Sci::wstring_view wsv, char *putf, size_t len) noexcept;
void UTF8FromUTF32Character(int uch, char *putf) noexcept;
size_t UTF16Length(Sci::string_view svu8) noexcept;
size_t UTF16FromUTF8(Sci::string_view svu8, wchar_t *tbuf, size_t tlen);
size_t UTF32Length(Sci::string_view svu8) noexcept;
size_t UTF32FromUTF8(Sci::string_view svu8, unsigned int *tbuf, size_t tlen);
// WStringFromUTF8 does the right thing when wchar_t is 2 or 4 bytes so
// works on both Windows and Unix.
std::wstring WStringFromUTF8(Sci::string_view svu8);
unsigned int UTF16FromUTF32Character(unsigned int val, wchar_t *tbuf) noexcept;
bool UTF8IsValid(Sci::string_view svu8) noexcept;
...
inline int UTF8Classify(Sci::string_view sv) noexcept {
