...
public:
	...
	virtual void DrawTextNoClip(PRectangle rc, const Font *font_, XYPOSITION ybase, const char *s, int len, ColourRGBA fore, ColourRGBA back) = 0;
	virtual void DrawTextClipped(PRectangle rc, const Font *font_, XYPOSITION ybase, const char *s, int len, ColourRGBA fore, ColourRGBA back) = 0;
	virtual void DrawTextTransparent(PRectangle rc, const Font *font_, XYPOSITION ybase, const char *s, int len, ColourRGBA fore) = 0;
	...
	virtual void DrawTextNoClipUTF8(PRectangle rc, const Font *font_, XYPOSITION ybase, const char *s, int len, ColourRGBA fore, ColourRGBA back) = 0;
	virtual void DrawTextClippedUTF8(PRectangle rc, const Font *font_, XYPOSITION ybase, const char *s, int len, ColourRGBA fore, ColourRGBA back) = 0;
	virtual void DrawTextTransparentUTF8(PRectangle rc, const Font *font_, XYPOSITION ybase, const char *s, int len, ColourRGBA fore) = 0;
	virtual void MeasureWidthsUTF8(const Font *font_, const char *s, int len, XYPOSITION *positions) = 0;
	virtual XYPOSITION WidthTextUTF8(const Font *font_, const char *s, int len) = 0;
